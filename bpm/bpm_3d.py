...
from volust.volgpu.oclalgos import OCLReductionKernel, OCLElementWiseKernel

from bpm.utils import StopWatch



def bpm_3d(size, units, lam = .5, u0 = None, dn = None, return_scattering = True):
    """
    ...
    """
    program = OCLProgram("kernels/bpm_3d_kernels.cl")
